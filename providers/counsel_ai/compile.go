...
// /cases/compile/nlp -> post
func Compile(c *gin.Context, reqBody CompileReq, typeOfAi string) (utils.BaseResponse, error) {
	...
	apiUrl := config.CounselAi.URL

	switch typeOfAi {
	case "nlp":
		apiUrl += "/cases/compile/nlp"
	case "chatgpt":
		apiUrl += "/cases/compile/chatgpt"
	case "ai21":
		apiUrl += "/cases/compile/ai21"
	default:
		apiUrl += "/cases/compile/nlp"
	}
